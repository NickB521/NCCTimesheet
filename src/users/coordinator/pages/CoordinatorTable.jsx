...
import { companyList } from "../../../assets/data/coordinatortable-data.jsx";


const CoordinatorTable = () => {
    const [workplaceList, setWorkplaceList] = useState(workplaceList)
    const [filteredWorkplaceList, setFilteredWorkplaceList] = useState(workplaceList);
    ...
    const currentItems = filteredWorkplaceList.slice(indexFirst, indexLast);
